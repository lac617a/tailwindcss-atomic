...
By default `targetFunctions` is `cn`, `clsx`, `classnames`, `cx`, `cva`, and `twMerge`. The plugin also rewrites:
...
<Callout type="warning">
  `cx("bg-neutral-300 bg-opacity-50")` with tailwind-merge v3 drops the color. Use `bg-neutral-300/50`. Details in [Preserve & runtime](./preserve).
</Callout>
